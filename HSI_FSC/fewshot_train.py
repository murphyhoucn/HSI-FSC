...
def fewshot_train(im_width, im_height, depth):
    ...
    save_model_name1 = \
        './model/' +\
        h5datasetname + '_' +\
        'embdeeing_fewshot_' + str(FEW_SHOT_EPISODE) + 'fewshotepisode.pkl'
    ...
    save_model_name2 = \
        './model/' +\
        h5datasetname + '_' +\
        'relation_fewshot_' + str(FEW_SHOT_EPISODE) + 'fewshotepisode.pkl'    
    torch.save(
...
if __name__ == '__main__':
    ...
    fewshot_train(im_width, im_height, depth)
