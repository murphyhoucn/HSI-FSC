...
feature_encoder.load_state_dict(torch.load(str("../model/SA_feature_encoder_20way_1shot_newmodel_5FT_1000.pkl")))
print("load feature encoder success")

relation_network.load_state_dict(torch.load(str("../model/SA_relation_network_20way_1shot_newmodel_5FT_1000.pkl")))
...
def test(im_width, im_height, channels):
    ...
    #A = time.time()
    # 加载支撑数据
    f = h5py.File('../h5dataset_ica_bandselect_200/SA_' + str(im_width) + '_' + str(im_height) + '_' + str(channels) + '_support' + str(args.n_shot) + '.h5', 'r')
    ...
    # 加载测试
    f = h5py.File(r'../h5dataset_ica_bandselect_200/SA_28_28_100_test.h5', 'r')  # 路径
...
################################################################
    ...
    path = '../result/' + 'SA_label_test_predict_' + nowtime_style +'.csv'
    ...
    f = open('../result/SA_' + nowtime_style +'.txt', 'w')
