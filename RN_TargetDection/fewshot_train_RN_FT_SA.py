...
def train(im_width, im_height, depth):
    ...
    # n_way测试！！！！！！！！！！！！！
    feature_encoder.load_state_dict(torch.load(str("../model/meta_training_feature_encoder_15way_1shot_newmodel.pkl"), map_location='cuda:0'))
    print("load feature encoder success")

    relation_network.load_state_dict(torch.load(str("../model/meta_training_relation_network_15way_1shot_newmodel.pkl"), map_location='cuda:0'))
    print("load relation network success")
