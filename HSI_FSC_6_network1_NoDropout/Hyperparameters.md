...
| **3** | **[20,  16, 6, 8, 8]** | **Inception Block** |             |           |           | [20,  16, 6, 8, 8] |
| 4 | [20,  16, 6, 8, 8] | Conv3d | (3, 3, 3) | (1, 1, 1) | (1, 1, 1) |                      |
|        |                      | BatchNorm3d |             |           |           |                      |
|        |                      | ReLU |             |           |           |                      |
...
| number | input                | operator    | kernel_size | padding   | stride    | output               |
| :------: | :--------------------: | :-----------: | :-----------: | :---------: | :---------: | :--------------------: |
| 1 | [20,  16, 6, 8, 8] | Conv3d | (1, 1, 1) | (0, 0, 0) | (1, 1, 1) | [20, 16, 6, 8, 8] |
| 2 | [20,  16, 6, 8, 8] |  Conv3d   |  (1, 1, 1)  | (0, 0, 0) | (1, 1, 1) |                   |
|        |                      | Conv3d | (3, 3, 3) | (1, 1, 1) | (1, 1, 1) | [20, 16, 6, 8, 8] |
| 3 | [20,  16, 6, 8, 8] | Conv3d | (1, 1, 1) | (0, 0, 0) | (1, 1, 1) |                      |
|        |                      | Conv3d | (5, 5, 5) | (2, 2, 2) | (1, 1, 1) | [20, 16, 6, 8, 8] |
| 4 | [20,  16, 6, 8, 8] | MaxPool3d | (3, 3, 3) | (1, 1, 1) | (1, 1, 1) |                      |
|        |                      | Conv3d | (1, 1, 1) | (0, 0, 0) | (1, 1, 1) | [20, 16, 6, 8, 8] |
| 5 | [20, 16, 6, 8, 8] | ReLU(1+2+3+4) |             |           |           | [20, 16, 6, 8, 8] |
