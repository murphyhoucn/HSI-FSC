...
feature_encoder.load_state_dict(torch.load(str("../model/IP_feature_encoder_20way_1shot_newmodel_5FT_1000.pkl")))
print("load feature encoder success")

relation_network.load_state_dict(torch.load(str("../model/IP_relation_network_20way_1shot_newmodel_5FT_1000.pkl")))
