...
if __name__ == '__main__':
    excel_data = pd.read_excel('./learningrate_acc_loss_Copy.xlsx', sheet_name='acc', header=0)
    acc(excel_data)
    excel_data = pd.read_excel('./learningrate_acc_loss_Copy.xlsx', sheet_name='loss', header=0)
    loss(excel_data)  